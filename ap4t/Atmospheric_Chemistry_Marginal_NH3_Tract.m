%% Adaptation of Atmospheric_Chemistry.m for Marginal NH3
...
NO3_Nitrate_Limit(:,1) = (-0.039.*dNH4e + 9.497*(HNO3_Base.*dNH4e));
NO3_Ammonia_Limit(:,1) = ( 0.519.*dNH4e + 7.900*(HNO3_Base.*dNH4e));
