...
dHNO3 = (HNO3_Total(:,1)-HNO3_Base(:,1));
NH4_NO3_Nitrate_Limit(:,1) = (0.365.*dHNO3 + 9.497*(dHNO3.*NH4e_Base)).*80;
NH4_NO3_Ammonia_Limit(:,1) = (0.348.*dHNO3 + 7.900*(dHNO3.*NH4e_Base)).*80;
...
% NH4_NO3_Nitrate_Limit(:,1) = (0.564.*(dHNO3)).*62;
% NH4_NO3_Ammonia_Limit(:,1) = (0.311.*(dHNO3)).*62;
